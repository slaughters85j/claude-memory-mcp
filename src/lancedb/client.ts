...
export let chunksTable: lancedb.Table | null = null;
export let chunksVectorStore: LanceDB | null = null;
export let catalogTable: lancedb.Table | null = null;
export let catalogVectorStore: LanceDB | null = null;
